...
{
    a_width -=2; //static_cast<uint8_t>(a_width - 2);
    //if (a_width) {
        write_register(SETUP_AW,a_width%4);// write_register(SETUP_AW, static_cast<uint8_t>(a_width % 4));
        addr_width = addr_width = (a_width%4) + 2;  //static_cast<uint8_t>((a_width % 4) + 2);
    /*}
    else {
